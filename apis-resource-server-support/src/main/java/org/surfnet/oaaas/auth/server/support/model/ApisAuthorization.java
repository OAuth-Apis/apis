...
public class ApisAuthorization implements Serializable {
  /*
  ...
  public ApisAuthorization() {
    super();
  }

  public ApisAuthorization(String error) {
    super();
    this.error = error;
  }

  public ApisAuthorization(String audience, List<String> scopes,
		AuthenticatedPrincipal principal, Long expiresIn) {
    super();
  ...
  public String toString() {
	return this.getClass().getName()+"{principal=\""+principal+"\", error=\""+error+"\"}";
  }
