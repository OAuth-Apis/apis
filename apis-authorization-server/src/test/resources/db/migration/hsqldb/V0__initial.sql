...
CREATE MEMORY TABLE PUBLIC.AUTHORIZATIONREQUEST(ID BIGINT NOT NULL PRIMARY KEY,CREATIONDATE TIMESTAMP,MODIFICATIONDATE TIMESTAMP,AUTHSTATE VARCHAR(255),AUTHORIZATIONCODE VARCHAR(255),ENCODEDPRINCIPAL VARCHAR(512),REDIRECTURI VARCHAR(255),RESPONSETYPE VARCHAR(255),STATE VARCHAR(255),CLIENT_ID BIGINT NOT NULL);
...
CREATE MEMORY TABLE PUBLIC.CLIENT(ID BIGINT NOT NULL PRIMARY KEY,CREATIONDATE TIMESTAMP,MODIFICATIONDATE TIMESTAMP,CLIENTID VARCHAR(255),CONTACTEMAIL VARCHAR(255),CONTACTNAME VARCHAR(255),DESCRIPTION VARCHAR(255),EXPIREDURATION BIGINT,CLIENTNAME VARCHAR(255),NOTALLOWEDIMPLICITGRANT BIT(1),SECRET VARCHAR(255) NOT NULL,SKIPCONSENT BIT(1),THUMBNAILURL VARCHAR(255),USEREFRESHTOKENS BIT(1),RESOURCESERVER_ID BIGINT NOT NULL,CONSTRAINT U_CLIENT_CLIENTID UNIQUE(CLIENTID),CONSTRAINT U_CLIENT_SECRET UNIQUE(SECRET));
